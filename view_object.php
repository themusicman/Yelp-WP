 ...
 * @author th3mus1cman
 **/
class View_Object extends View_Core {
	
	protected static $base_path;
	
	/**
	 * Returns a new View_Object
	 *
	 * @chainable
	...
	{
		return new View_Object(View_Object::$base_path.$file.'.php', $data);
	}
	 ...
	 *
	 * @access public
	 * @param  string base_path base path to the view directory	
	 * @return void
	 * 
	 **/
	public static function set_basepath($base_path) 
	{
		View_Object::$base_path = $base_path;
	}
...
class View_Core {
	...
	public function render($file = NULL)
	{
		...
		if (empty($this->_file))
		{
			...
			throw new Exception('No file specified for view, unable to render');
		}
